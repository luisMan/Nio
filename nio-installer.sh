...
APP_NAME="nio"
APP_VERSION="0.1.176"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/luisMan/Nio/releases/download/v0.1.176}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.14.1"},"source":{"app_name":"nio","name":"Nio","owner":"luisMan","release_type":"github"},"version":"0.1.176"}
EORECEIPT
...
The installer for nio 0.1.176

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/luisMan/Nio/releases/download/v0.1.176
...
download_binary_and_run_installer() {
    ...
    case "$_arch" in 
        "aarch64-apple-darwin")
            _artifact_name="nio-aarch64-apple-darwin.tar.xz"
            _zip_ext=".tar.xz"
            _bins="nio"
            _bins_js_array='"nio"'
            _updater_name=""
        ...
        "x86_64-pc-windows-gnu")
            _artifact_name="nio-x86_64-pc-windows-msvc.zip"
            _zip_ext=".zip"
            _bins="nio.exe"
            _bins_js_array='"nio.exe"'
            _updater_name=""
            _updater_bin=""
            ;;
        "x86_64-unknown-linux-gnu")
            _artifact_name="nio-x86_64-unknown-linux-gnu.tar.xz"
            _zip_ext=".tar.xz"
            _bins="nio"
            _bins_js_array='"nio"'
            _updater_name=""
