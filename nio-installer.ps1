...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/luisMan/Nio/releases/download/v0.1.171',
...
function Invoke-Installer($bin_paths, $platforms) {
  ...
  [IO.File]::WriteAllLines("$receipt_home/nio-receipt.json", "$receipt", $Utf8NoBomEncoding)
